...
if __name__ == "__main__":
    root_pool = TGroup(
        'root@pc13.cloudlab.umass.edu',
        'root@pc12.cloudlab.umass.edu',
        'root@pc22.cloudlab.umass.edu',
        'root@pc16.cloudlab.umass.edu',
        'root@pc08.cloudlab.umass.edu',
        'root@pc20.cloudlab.umass.edu',
        'root@pc06.cloudlab.umass.edu',
        'root@pc14.cloudlab.umass.edu',
    )
    nonroot_pool = TGroup(
        'martinlp@pc13.cloudlab.umass.edu',
        'martinlp@pc12.cloudlab.umass.edu',
        'martinlp@pc22.cloudlab.umass.edu',
        'martinlp@pc16.cloudlab.umass.edu',
        'martinlp@pc08.cloudlab.umass.edu',
        'martinlp@pc20.cloudlab.umass.edu',
        'martinlp@pc06.cloudlab.umass.edu',
        'martinlp@pc14.cloudlab.umass.edu',
)
    CONTROL_PLANE = 'c220g2-010611.wisc.cloudlab.us'
    ...
    # test_docker(nonroot_pool)
    # setup_access_all_nodes(root_pool)
    # disable_swap(root_pool)
    # install_gh(nonroot_pool)
    # setup_python_all_nodes(root_pool)
    # setup_js_all_nodes(root_pool)

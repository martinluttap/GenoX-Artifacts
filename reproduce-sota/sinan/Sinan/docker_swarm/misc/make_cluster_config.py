...
IP_ADDR = {}
IP_ADDR["sinan-compute1"]       = "129.114.108.255"
IP_ADDR["sinan-compute2"]       = "129.114.108.77"
IP_ADDR["sinan-compute3"]       = "129.114.109.73"
IP_ADDR["sinan-gpu1"]           = "129.114.109.101"
...
service_config = {
    ...
    "media-service":        {'max_replica': 2, 'max_cpus': 4},
    # "media-filter-service": {'max_replica': 16, 'max_cpus': 128},
    "media-filter-service": {'max_replica': 1, 'max_cpus': 32},
    ...
    "home-timeline-service":    {'max_replica': 2},
...
for node in nodes:
    ...
    if node == 'sinan-compute2':
        node_config[node]['cpus'] = 96
        node_config[node]['label'] = 'type=compute'
    elif node == 'sinan-compute3':
        node_config[node]['cpus'] = 96

...
def run_exp(users, log_dir):
	...
	locust_p = run_locust(
		...
		nginx_ip='http://127.0.0.1:8111', volumes=LocustVolumes,
...
def main():
	...
	print(f'Connected with slaves {Servers}')

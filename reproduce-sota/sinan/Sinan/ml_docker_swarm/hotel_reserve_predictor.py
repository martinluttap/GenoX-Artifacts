...
parser.add_argument('--model-prefix', dest='model_prefix', type=str, default='./model/cnv_hotel')
...
parser.add_argument('--xgb-prefix', dest='xgb_prefix', type=str, 
	default='./xgb_model/hotel_nn_sys_state_look_forward_')
...
def test():
	...
	Model.bind(for_training=False, 
		data_shapes=[('data1', (default_batch_size,6,len(Services),CnnTimeSteps)), 
					 ...
					 # ('data3', (default_batch_size,2,len(Services)))
